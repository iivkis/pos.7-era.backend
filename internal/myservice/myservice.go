...
func NewMyService(repo *repository.Repository, strcode *strcode.Strcode, mailagent *mailagent.MailAgent, authjwt *authjwt.AuthJWT, s3cloud *s3cloud.SelectelS3Cloud) MyService {
	return MyService{
